...
3. В открывшемся графическом интерфейсе заполните API URL и ID модели
   ...
   - **Внимательно различайте названия моделей, чтобы не конфликтовать со встроенными именами моделей:**
...
2. В графическом интерфейсе заполните:
   ...
   - **ID модели**: пользовательское название модели (избегайте конфликтов со встроенными моделями)
